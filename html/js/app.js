...
var playerMaxWeight = 0.0;
var otherMaxWeight = 0.0;
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        // $('.namejs').html('<i class="fa fa-id-badge"></i> '+v.pid+' | NAME: '+v.pname+'')
        $('.namejs').html('<i class="fa fa-id-badge"></i> '+v.pid+' |  <i class="fa-solid fa-sack-dollar"></i>  $'+v.cash.toFixed(2)+' |  <i class="fa-solid fa-sack-xmark"></i>  $'+v.bloodmoney.toFixed(2)+'')
        // $('.moneyjs').html('<i class="fa-solid fa-sack-dollar"></i>  $'+v.cash+'')
        // $('.bloodmoneyjs').html('<i class="fa-solid fa-sack-xmark"></i>  $'+v.bloodmoney+'')
...
// $("#item-clip").droppable({
// $(document).on("click", ".item-clip", function() {
//         $.post(
//             "https://rsg-inventory/ClipItem",
//         );
//     },
// );
...
$("#item-clip").click(function () {
    Inventory.Close();
    $.post('https://rsg-inventory/ClipItem', JSON.stringify({}));
    return
})
